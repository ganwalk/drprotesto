...
export function CtaFinal() {
  return (
    <section className="px-5 pb-20 lg:px-8 lg:pb-28">
      <div className="relative mx-auto max-w-[1240px] overflow-hidden rounded-3xl bg-navy-900 px-8 py-16 lg:px-16 lg:py-20">
        <div
          className="pointer-events-none absolute inset-0"
          style={{
            background:
              "radial-gradient(90% 130% at 88% 8%, rgba(95,156,194,0.35) 0%, transparent 58%)",
          }}
          aria-hidden
        />
